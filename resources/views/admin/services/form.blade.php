<x-admin.layout title="{{ $action === 'edit' ? 'Modifier : ' . $service->title : 'Nouveau service' }}">
    <div class="max-w-2xl">
        <div class="flex items-center gap-3 mb-6">
            <a href="{{ route('admin.services.index') }}" class="text-slate-400 hover:text-white text-sm">← Retour</a>
        </div>
            ...
            <form method="POST"
                ...
                <div class="grid sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        @error('title')<p class="text-neon-rose text-xs mt-1">{{ $message }}</p>@enderror
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-300 mb-1.5">Icône (emoji)</label>
                ...
                <div class="grid sm:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-sm font-medium text-slate-300 mb-1.5">Ordre d'affichage</label>
                    ...
                    <div class="flex items-center gap-3 mt-5">
                        ...
                        <label for="active" class="text-sm text-slate-300">Service actif (visible)</label>
                    </div>
                </div>
                ...
                <div>
                    ...
                    @error('excerpt')<p class="text-neon-rose text-xs mt-1">{{ $message }}</p>@enderror
                </div>
                ...
                <div>
                    ...
                    @error('content')<p class="text-neon-rose text-xs mt-1">{{ $message }}</p>@enderror
                </div>

                <div>
                    <label class="block text-sm font-medium text-slate-300 mb-1.5">Fonctionnalités / bénéfices</label>
                    ...
                    <p class="text-xs text-slate-500 mt-1">Une fonctionnalité par ligne</p>
                </div>

                <div>
                    <label class="block text-sm font-medium text-slate-300 mb-1.5">Technologies</label>
                    ...
                    <p class="text-xs text-slate-500 mt-1">Séparées par des virgules</p>
                </div>
