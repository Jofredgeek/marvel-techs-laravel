    ...
    <div class="pt-28 pb-24">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <h1 class="text-4xl font-extrabold text-[var(--heading)] mb-4 mt-4">Parlons de votre projet</h1>
            ...
            <form action="{{ route('quote.store') }}" method="POST" class="glass rounded-xl p-8 space-y-5">
                ...
                <div>
                    <label for="service" class="block text-sm font-medium text-[var(--text)] opacity-90 mb-1.5">
                        Service concerné <span class="text-[var(--danger)]">*</span>
                    </label>
                    ...
                    @error('service')<p class="text-[var(--danger)] text-xs mt-1">{{ $message }}</p>@enderror
                </div>

                <div class="grid sm:grid-cols-2 gap-5">
                    <div>
                        <label for="budget"
                            class="block text-sm font-medium text-[var(--text)] opacity-90 mb-1.5">Budget <span
                                class="text-[var(--danger)]">*</span></label>
                        ...
                        @error('budget')<p class="text-[var(--danger)] text-xs mt-1">{{ $message }}</p>@enderror
                    </div>
                ...
                <div class="flex items-start gap-3 text-sm text-[var(--muted)]">
                    <svg class="w-5 h-5 text-[var(--success)] shrink-0 mt-0.5" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
            ...
            <div class="mt-8 text-center">
                <p class="text-[var(--muted)] opacity-70 text-sm">Vous préférez un échange direct ? <a
                        href="{{ route('contact') }}" class="text-[var(--primary)] hover:underline">Envoyez-nous un
                        message</a></p>
            </div>
        </div>
    </div>
