            ...
            <div class="grid lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="text-center py-16 glass rounded-xl">
                        ...
                        <p class="text-slate-400">Aucun article disponible pour le moment.</p>
                    </div>
                    @else
                    <div class="grid gap-6 sm:grid-cols-2">
                        ...
                        <a href="{{ route('blog.show', $post->slug) }}"
                            ...
                            <div class="p-5">
                                ...
                                <h2
                                    class="font-bold text-white group-hover:text-neon-cyan transition-colors mb-2 leading-snug">
                                    {{ $post->title }}
                                </h2>
                                <p class="text-slate-400 text-sm leading-relaxed mb-3 line-clamp-2">{{ $post->excerpt }}
                                </p>
                ...
                <div class="space-y-6">
                    {{-- Newsletter --}}
                    <div class="glass rounded-xl p-5 border border-neon-cyan/15">
                        <h3 class="font-bold text-white mb-2">📬 Newsletter</h3>
                        <p class="text-slate-400 text-xs mb-4">Recevez nos meilleurs articles chaque semaine.</p>
                    ...
                    <div class="glass rounded-xl p-5">
                        <h3 class="font-semibold text-white text-sm mb-3">Catégories</h3>
                        <ul class="space-y-2">
                            @foreach(['Cybersécurité', 'Réseaux', 'Cloud', 'Développement Web', 'Support IT', 'DevOps']
                            as $cat)
                            <li>
                                <a href="{{ route('blog.index', ['category' => $cat]) }}"
                                    class="flex items-center justify-between text-slate-400 hover:text-neon-cyan text-sm transition-colors py-1">
                                    <span>{{ $cat }}</span>
                    ...
                    {{-- CTA --}}
                    <div class="glass rounded-xl p-5 border border-neon-violet/15">
                        <div class="text-2xl mb-2">🚀</div>
                        <h3 class="font-semibold text-white text-sm mb-2">Besoin d'expertise ?</h3>
                        <p class="text-slate-400 text-xs mb-4">Contactez-nous pour un audit gratuit de 15 min.</p>
